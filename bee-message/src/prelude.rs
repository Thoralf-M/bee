...
pub use crate::{
    ...
    payload::{
        ...
        transaction::{
            Address, ConsumedOutput, CreatedOutput, Ed25519Address, Ed25519Signature, Input, Output, OutputId,
            ReferenceUnlock, SignatureLockedDustAllowanceOutput, SignatureLockedSingleOutput, SignatureUnlock,
            TransactionId, TransactionPayload, TransactionPayloadBuilder, TransactionPayloadEssence,
